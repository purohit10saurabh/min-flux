"""
Minimal Flux Kontext (FLUX.1-Kontext) training loop — reference-image conditioned training.
...
2) All other components inherited from flux1/training_loop.py (see its header for sources)
"""
...
def flux_kontext_training_loop(
    transformer, vae, noise_scheduler, optimizer, lr_scheduler,
